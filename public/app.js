...
(function () {
  ...
  // 🔥 Suodatusnapit (HTML:ssä placeholderit)
  ...
  // =========================
  let tasks = loadTasks();
  let activePriorityFilter = null; // null = ei suodatusta
  ...
  function render() {
    ...
    const visibleTasks = activePriorityFilter
  ...
  filters.addEventListener('click', (e) => {
    ...
    activePriorityFilter = filter === 'all' ? null : filter;
    render();
  });
